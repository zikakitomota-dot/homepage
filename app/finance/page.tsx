  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="border-y border-border/60 bg-secondary/20"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">Match the evidence to the question</h2><p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">A calculator can organise arithmetic, but the useful input usually comes from a receipt, product label, offer terms or a plan you can realistically maintain.</p><div className="mt-7 overflow-x-auto rounded-2xl border border-border/70 bg-white p-4"><table className="w-full min-w-[680px] text-left"><caption className="sr-only">Evidence to check before using each finance calculator</caption><thead><tr><th className="border-b p-3">Decision</th><th className="border-b p-3">Check first</th><th className="border-b p-3">Use</th><th className="border-b p-3">Does not answer</th></tr></thead><tbody><tr><td className="border-b p-3 font-semibold">Is the sale cheaper?</td><td className="border-b p-3">Original price and extra charges</td><td className="border-b p-3"><Link className="text-primary hover:underline" href="/finance/discount-calculator">Discount</Link></td><td className="border-b p-3">Whether you need the item</td></tr><tr><td className="border-b p-3 font-semibold">Which pack is better value?</td><td className="border-b p-3">Comparable net quantities</td><td className="border-b p-3"><Link className="text-primary hover:underline" href="/finance/unit-price-calculator">Unit price</Link></td><td className="border-b p-3">Quality or waste</td></tr><tr><td className="border-b p-3 font-semibold">What will the reward really be?</td><td className="border-b p-3">Eligibility, cap and redemption terms</td><td className="border-b p-3"><Link className="text-primary hover:underline" href="/finance/cashback-calculator">Cashback</Link></td><td className="border-b p-3">Whether approval is guaranteed</td></tr><tr><td className="p-3 font-semibold">When could I reach a goal?</td><td className="p-3">Current savings and sustainable contribution</td><td className="p-3"><Link className="text-primary hover:underline" href="/finance/savings-goal-calculator">Savings goal</Link></td><td className="p-3">Interest or future price changes</td></tr></tbody></table></div></div></section>

        <section className="border-t border-border/60 bg-blue-50/40"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">One purchase can involve three different comparisons</h2><p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">Suppose two detergent packs have different sizes, one is discounted, and the store offers capped cashback. First calculate each sale price, then compare both on the same unit—such as cost per 100 ml—and only then apply cashback to eligible spending. A large percentage badge does not guarantee the lowest final unit cost.</p><p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">That order matters because the calculators answer different questions: discount changes the checkout price, unit price compares quantity, and cashback describes a later reward subject to merchant rules. Keep the intermediate figures rather than treating the three percentages as interchangeable.</p><Link href="/guides/percentage-points-vs-percentage-change" className="mt-6 inline-flex min-h-11 items-center font-semibold text-primary hover:underline">Understand another commonly confused percentage comparison<ArrowRight className="ml-1 h-4 w-4" aria-hidden="true" /></Link></div></section>
