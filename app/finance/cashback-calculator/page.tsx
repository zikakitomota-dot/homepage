...
export default function Page() {
  return <CalculatorPage title="Cashback Calculator" description={description} calculator={<CashbackCalculator />}
    ...
    decisionContext={<div className="grid gap-7 lg:grid-cols-[.8fr_1.2fr]"><div><h2 className="text-3xl font-bold tracking-tight">Find the point where the cap takes over</h2><p className="mt-4 leading-relaxed text-muted-foreground">Divide the reward cap by the cashback rate written as a decimal. A RM10 cap at 5% is reached at RM200 of eligible spending. Above RM200, the reward stays RM10 and the effective rate falls.</p></div><div className="overflow-x-auto rounded-2xl border border-border/70 bg-white p-5"><table className="w-full text-left"><caption className="sr-only">Example of a five percent cashback offer capped at ten ringgit</caption><thead><tr><th className="border-b p-3">Eligible spend</th><th className="border-b p-3">Reward</th><th className="border-b p-3">Effective rate</th></tr></thead><tbody><tr><td className="border-b p-3">RM100</td><td className="border-b p-3">RM5</td><td className="border-b p-3">5%</td></tr><tr><td className="border-b p-3">RM200</td><td className="border-b p-3">RM10</td><td className="border-b p-3">5%</td></tr><tr><td className="p-3">RM400</td><td className="p-3">RM10</td><td className="p-3">2.5%</td></tr></tbody></table></div></div>}
    faqs={[
