...
export default function OvertimeCalculatorPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-y border-border/60 bg-amber-50/50"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">Collect the policy inputs before calculating pay</h2><p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">This tool applies the threshold and multiplier you enter; it cannot decide whether a worker is legally or contractually entitled to overtime.</p><ul className="mt-7 grid gap-4 md:grid-cols-2"><li className="rounded-2xl border border-amber-200 bg-white p-5"><strong>Threshold basis:</strong> daily, weekly, pay-period or another rule</li><li className="rounded-2xl border border-amber-200 bg-white p-5"><strong>Hours counted:</strong> worked time after unpaid breaks and any exclusions</li><li className="rounded-2xl border border-amber-200 bg-white p-5"><strong>Rate basis:</strong> regular, blended or another contract-defined rate</li><li className="rounded-2xl border border-amber-200 bg-white p-5"><strong>Special rules:</strong> public holidays, double time, comp time and multiple tiers</li></ul><p className="mt-6 max-w-3xl leading-relaxed text-muted-foreground">If more than one threshold or multiplier applies, calculate each eligible block separately and compare the total with the payslip, employer policy and applicable local rules.</p></div></section>
