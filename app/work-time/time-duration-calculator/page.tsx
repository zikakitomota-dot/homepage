  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="border-y border-border/60 bg-blue-50/40"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">Clock time, elapsed time and decimal time are different conventions</h2><div className="mt-7 grid gap-5 md:grid-cols-2"><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">State the overnight assumption</h3><p className="mt-3 leading-relaxed text-muted-foreground">With no dates, 10:00 PM to 2:00 AM is treated as four hours ending the next day. Use dates when a duration may span more than one midnight.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Convert minutes by dividing by 60</h3><p className="mt-3 leading-relaxed text-muted-foreground">7 hours 30 minutes is 7.5 decimal hours, not 7.30. Decimal hours are useful for arithmetic; hours:minutes are often easier to read.</p></div></div><p className="mt-6 leading-relaxed text-muted-foreground">The calculator treats timestamps as entered. It does not resolve time zones, daylight-saving clock changes or whether endpoints should count as inclusive calendar days.</p></div></section>
