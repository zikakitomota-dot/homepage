  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="border-t border-border/60 bg-blue-50/40"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">A useful timesheet check</h2><div className="mt-7 grid gap-5 md:grid-cols-3"><div className="rounded-2xl border border-border/70 bg-white p-6"><p className="text-sm font-bold uppercase tracking-wider text-primary">1 · Record</p><h3 className="mt-2 text-xl font-bold">Start and finish</h3><p className="mt-3 leading-relaxed text-muted-foreground">Record the actual times for each shift, including whether an overnight finish belongs to the following day.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><p className="text-sm font-bold uppercase tracking-wider text-primary">2 · Subtract</p><h3 className="mt-2 text-xl font-bold">Unpaid breaks</h3><p className="mt-3 leading-relaxed text-muted-foreground">Separate unpaid meal or rest time from the elapsed shift. A nine-hour span with a one-hour unpaid break represents eight worked hours.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><p className="text-sm font-bold uppercase tracking-wider text-primary">3 · Compare</p><h3 className="mt-2 text-xl font-bold">Records and rules</h3><p className="mt-3 leading-relaxed text-muted-foreground">Compare the total with the timesheet or payslip, then apply the employer&apos;s overtime threshold and rounding rule rather than assuming the calculator sets policy.</p></div></div></div></section>
      </main>
      <SiteFooter />
    </div>
  );
