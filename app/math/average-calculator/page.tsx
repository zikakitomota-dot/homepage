...
export default function AverageCalculatorPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-y border-border/60 bg-blue-50/40" aria-labelledby="choose-summary"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 id="choose-summary" className="text-3xl font-bold tracking-tight">Choose the summary that answers the real question</h2><div className="mt-7 grid gap-5 md:grid-cols-3"><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Mean shares a total</h3><p className="mt-3 leading-relaxed text-muted-foreground">For 6, 7, 8 and 11 hours, the mean of 8 describes the total spread equally across four observations.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Median finds the middle</h3><p className="mt-3 leading-relaxed text-muted-foreground">For 6, 7, 8 and 40, the mean is 15.25 but the median is 7.5, which is less pulled by the unusually high value.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Mode finds frequency</h3><p className="mt-3 leading-relaxed text-muted-foreground">For shoe sizes 5, 6, 6, 7 and 8, the mode is 6. It identifies the most common value but not the full spread.</p></div></div><p className="mt-6 max-w-3xl leading-relaxed text-muted-foreground">Keep the original values visible and explain why the selected summary fits the decision. A statistic is not automatically representative just because it is easy to calculate.</p></div></section>
