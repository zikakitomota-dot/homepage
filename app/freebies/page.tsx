  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section className="border-y border-border/60 bg-secondary/25" aria-labelledby="choose-download-heading"><div className="mx-auto max-w-[1100px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 id="choose-download-heading" className="text-3xl font-bold tracking-tight">Choose a download by the task in front of you</h2><div className="mt-7 grid gap-5 md:grid-cols-3"><div className="rounded-2xl border border-border/60 bg-white p-6"><h3 className="text-xl font-bold">Organise a learning week</h3><p className="mt-3 leading-6 text-muted-foreground">Use the <Link href="/freebies/study-planner" className="font-semibold text-primary hover:underline">Study Planner</Link> for upcoming work, or the <Link href="/freebies/grade-tracker" className="font-semibold text-primary hover:underline">Grade Tracker</Link> when the main need is recording scores and deadlines.</p></div><div className="rounded-2xl border border-border/60 bg-white p-6"><h3 className="text-xl font-bold">Support one early skill</h3><p className="mt-3 leading-6 text-muted-foreground">Choose phonics for first sounds, pre-writing for pencil paths, scissor practice for cutting, or the observation tracker when an adult needs factual notes rather than another child worksheet.</p></div><div className="rounded-2xl border border-border/60 bg-white p-6"><h3 className="text-xl font-bold">Plan a specific money goal</h3><p className="mt-3 leading-6 text-muted-foreground">A savings tracker records progress, the big-purchase sheet compares full costs, and the emergency-fund sheet separates unexpected essentials from planned spending.</p></div></div><p className="mt-6 max-w-3xl text-sm leading-6 text-muted-foreground">Preview each landing page before downloading. The page list, intended audience, safety notes and filled illustration—where provided—help you decide whether the printable fits the task.</p></div></section>
