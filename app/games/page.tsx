...
import { ArrowRight, BookOpen, GraduationCap, Languages, Leaf, Plus } from 'lucide-react';
...
export const metadata = createEducationalMetadata({
  ...
  description: 'Explore free, mobile-friendly English and Math games for children. Practise grammar or basic addition with no account or login required.',
  path: '/games',
});
...
export default function GamesPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    <section className="border-b border-border/60 bg-blue-50/70"><div className="mx-auto max-w-[1000px] px-4 py-16 text-center sm:px-6 lg:px-8 lg:py-24">
      ...
      <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">Build English and Math skills through short, friendly games designed for phones, tablets, and computers.</p>
    </div></section>
    <section className="mx-auto max-w-[1000px] px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="border-blue-200 shadow-md"><CardHeader><span className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-primary"><Plus className="h-7 w-7" aria-hidden="true" /></span><CardTitle className="text-2xl">Math Games</CardTitle></CardHeader><CardContent><p className="max-w-2xl leading-relaxed text-muted-foreground">Start with Addition Level 1: a free 10-question game covering addition within 10 and 20 for young learners.</p><Button asChild size="lg" className="mt-6 min-h-12"><Link href="/games/math/addition-level-1">Play Addition Level 1<ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" /></Link></Button></CardContent></Card>
        <Card className="border-[#c9d8bd] shadow-md"><CardHeader><span className="mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-[#e7f0df] text-[#52704d]"><Leaf className="h-7 w-7" aria-hidden="true" /></span><CardTitle className="text-2xl">Science Games</CardTitle></CardHeader><CardContent><p className="max-w-2xl leading-relaxed text-muted-foreground">Meet 16 animals and match each one to the forest, desert, ocean, or ice and snow.</p><Button asChild size="lg" className="mt-6 min-h-12 bg-[#52704d] hover:bg-[#435e40]"><Link href="/games/science/animal-habitats">Play Where Do I Live?<ArrowRight className="ml-2 h-5 w-5" aria-hidden="true" /></Link></Button></CardContent></Card>
      </div>
    ...
    <section className="border-y border-border/60 bg-secondary/30"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
      ...
      <div className="mt-8 grid gap-5 md:grid-cols-3">
        <div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">For first-time learners</h3><p className="mt-3 leading-relaxed text-muted-foreground">Start with <Link href="/games/science/animal-habitats" className="font-semibold text-primary hover:underline">Where Do I Live?</Link>, <Link href="/games/math/addition-level-1" className="font-semibold text-primary hover:underline">Addition Level 1</Link>, or <Link href="/games/english/a-or-an" className="font-semibold text-primary hover:underline">A or An?</Link>. Each uses short questions that suit early primary practice.</p></div>
