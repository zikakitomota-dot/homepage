...
export default function EnglishGamesPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-y border-border/60 bg-secondary/30"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">A practical order for first-time learners</h2><p className="mt-4 max-w-3xl leading-relaxed text-muted-foreground">There is no required level sequence, but starting with a visible clue can make the next grammar decision easier. Move on when the learner can explain the clue, not only when a score is high.</p><ol className="mt-7 grid gap-4 md:grid-cols-2"><li className="rounded-2xl border border-border/70 bg-white p-6"><strong>1. Notice one or many.</strong><p className="mt-2 text-muted-foreground">Begin with <Link href="/games/english/one-or-many" className="font-semibold text-primary hover:underline">One or Many?</Link>, then combine number with distance in <Link href="/games/english/this-that-these-those" className="font-semibold text-primary hover:underline">This, That, These or Those?</Link>.</p></li><li className="rounded-2xl border border-border/70 bg-white p-6"><strong>2. Identify who or what.</strong><p className="mt-2 text-muted-foreground">Use <Link href="/games/english/he-she-it" className="font-semibold text-primary hover:underline">He, She, It</Link> and <Link href="/games/english/who-is-it" className="font-semibold text-primary hover:underline">Who Is It?</Link> before asking the subject to control a verb.</p></li><li className="rounded-2xl border border-border/70 bg-white p-6"><strong>3. Match subject and verb.</strong><p className="mt-2 text-muted-foreground">Practise <Link href="/games/english/is-am-are" className="font-semibold text-primary hover:underline">Is, Am, Are</Link> and <Link href="/games/english/has-or-have" className="font-semibold text-primary hover:underline">Has or Have?</Link> by saying the subject pair aloud.</p></li><li className="rounded-2xl border border-border/70 bg-white p-6"><strong>4. Add meaning relationships.</strong><p className="mt-2 text-muted-foreground">Use <Link href="/games/english/whose-is-it" className="font-semibold text-primary hover:underline">Whose Is It?</Link> for ownership and <Link href="/games/english/where-is-it" className="font-semibold text-primary hover:underline">Where Is It?</Link> for position.</p></li></ol></div></section>
    ...
    <section className="border-y border-border/60 bg-secondary/30"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">Choose a game from the clue a child is missing</h2><div className="mt-7 grid gap-5 md:grid-cols-2"><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Listen for number and distance</h3><p className="mt-3 leading-relaxed text-muted-foreground">If a learner mixes up one and many, begin with <Link href="/games/english/one-or-many" className="font-semibold text-primary hover:underline">One or Many?</Link>. When number is secure, <Link href="/games/english/this-that-these-those" className="font-semibold text-primary hover:underline">This, That, These or Those?</Link> adds the near-or-far clue.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="text-xl font-bold">Listen for the sentence subject</h3><p className="mt-3 leading-relaxed text-muted-foreground">Use <Link href="/games/english/he-she-it" className="font-semibold text-primary hover:underline">He, She, It</Link> to identify the subject first. Then practise how that subject changes the verb in <Link href="/games/english/is-am-are" className="font-semibold text-primary hover:underline">Is, Am, Are</Link> or <Link href="/games/english/has-or-have" className="font-semibold text-primary hover:underline">Has or Have?</Link>.</p></div></div><p className="mt-6 max-w-3xl leading-relaxed text-muted-foreground">Position and ownership use different clues: <Link href="/games/english/where-is-it" className="font-semibold text-primary hover:underline">Where Is It?</Link> asks where an object is, while <Link href="/games/english/whose-is-it" className="font-semibold text-primary hover:underline">Whose Is It?</Link> asks who owns it. Practising the question meaning before the answer choices helps prevent random matching.</p></div></section>
