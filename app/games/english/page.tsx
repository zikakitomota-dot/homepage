...
export default function EnglishGamesPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-y border-violet-200 bg-violet-50/70"><div className="mx-auto max-w-[900px] px-4 py-14 text-center sm:px-6 lg:px-8 lg:py-20">
      ...
      <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-violet-900">Loved the free games? Preview the planned Grammar Level 2 and Vocabulary Level 1 library—20 more interactive games designed to help children build stronger English skills.</p>
