...
import { AcademyUnlock } from '@/components/games/academy-unlock';
...
export default async function AcademyPage() {
  const academyUnlocked = await hasAcademyAccess();
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="border-y border-border/60 bg-violet-50/40" aria-labelledby="academy-comparison-heading"><div className="mx-auto max-w-[900px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 id="academy-comparison-heading" className="text-3xl font-bold tracking-tight">Free collection and Lifetime Access compared</h2><div className="mt-7 overflow-x-auto rounded-2xl border border-violet-200 bg-white p-4"><table className="w-full min-w-[620px] text-left"><caption className="sr-only">Comparison of the free English games and Zalea English Academy Lifetime Access</caption><thead><tr><th className="border-b p-3">Feature</th><th className="border-b p-3">Free Grammar Level 1</th><th className="border-b p-3">Lifetime Access</th></tr></thead><tbody><tr><td className="border-b p-3 font-semibold">Games available now</td><td className="border-b p-3">10 grammar games</td><td className="border-b p-3">10 Grammar Level 2 + 10 Vocabulary Level 1 games</td></tr><tr><td className="border-b p-3 font-semibold">Access</td><td className="border-b p-3">Open in the browser, no login</td><td className="border-b p-3">License key unlocks Academy on the device</td></tr><tr><td className="border-b p-3 font-semibold">Best fit</td><td className="border-b p-3">First practice with core grammar choices</td><td className="border-b p-3">More grammar patterns and themed vocabulary</td></tr><tr><td className="p-3 font-semibold">Payment</td><td className="p-3">Free</td><td className="p-3">One-time purchase; no monthly subscription</td></tr></tbody></table></div></div></section>
