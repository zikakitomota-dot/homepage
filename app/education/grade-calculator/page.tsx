...
const title = 'Grade Calculator – Calculate Your Overall Grade | Zalea Studio';
const description = 'Calculate your overall grade from assignments, quizzes, tests and exams. Add multiple scores, view your percentage and see your estimated letter grade instantly.';
...
const faqs = [
  { question: 'How do I calculate my grade percentage?', answer: 'Divide the points earned by the total possible points, then multiply the result by 100. For example, 42 divided by 50 multiplied by 100 is 84%.' },
  { question: 'How do I calculate my overall grade from multiple assignments?', answer: 'Add the points earned across every assignment, add all available points, then divide total earned points by total available points and multiply by 100.' },
  ...
  { question: 'Is this calculator the same as a weighted grade calculator?', answer: 'No. This points-based calculator divides total earned points by total available points. A weighted grade calculator applies percentage weights to categories or assignments. A separate weighted calculator may be available later.' },
];
...
export default function GradeCalculatorPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-b border-border/60 bg-gradient-to-b from-blue-50/70 to-background"><div className="mx-auto max-w-[1200px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><nav aria-label="Breadcrumb" className="mb-5 flex flex-wrap items-center gap-2 text-sm text-muted-foreground"><Link href="/" className="hover:text-foreground hover:underline">Home</Link><span aria-hidden="true">/</span><Link href="/education" className="hover:text-foreground hover:underline">Education</Link><span aria-hidden="true">/</span><span aria-current="page">Grade Calculator</span></nav><Link href="/education" className="inline-flex items-center text-sm font-medium text-primary hover:underline"><ArrowLeft className="mr-2 h-4 w-4" aria-hidden="true" />All Education Tools</Link><Badge variant="secondary" className="mt-6 block w-fit border-primary/20 bg-primary/10 text-primary">Free calculator</Badge><h1 className="mt-4 max-w-4xl text-balance text-4xl font-bold tracking-tight sm:text-5xl">Grade Calculator</h1><p className="mt-5 max-w-3xl text-lg leading-relaxed text-muted-foreground">Calculate your overall grade by entering your scores below. Add assignments, quizzes, tests or any graded work to find your total percentage and estimated letter grade.</p></div></section>
    <section className="mx-auto max-w-[1200px] px-4 py-10 sm:px-6 lg:px-8 lg:py-14"><GradeCalculator /></section>
    <section className="border-y border-border/60 bg-secondary/30"><div className="mx-auto grid max-w-[1000px] gap-6 px-4 py-14 sm:px-6 md:grid-cols-2 lg:px-8 lg:py-20"><InfoCard title="How to Calculate Your Grade"><p><strong>Grade Percentage = Points Earned ÷ Total Points × 100</strong></p><p className="mt-3">For example: 42 ÷ 50 × 100 = <strong>84%</strong>.</p><p className="mt-3">Calculating a quiz where every question has equal value? Try the <Link href="/education/test-grade-calculator" className="font-semibold text-primary hover:underline">Test Grade Calculator</Link>. For course letter grades and credits, use the <Link href="/education/gpa-calculator" className="font-semibold text-primary hover:underline">GPA Calculator</Link>.</p></InfoCard><InfoCard title="How the Overall Grade Calculator Works"><p>For multiple assignments, Zalea Studio adds all earned points and divides them by all possible points. For example: 183 points earned ÷ 220 possible points × 100 = <strong>83.18%</strong>.</p><p className="mt-3">This is a <strong>points-based grade calculator</strong>, so it does not simply average each assignment percentage. If categories have different percentage weights, use the <Link href="/education/weighted-grade-calculator" className="font-semibold text-primary hover:underline">Weighted Grade Calculator</Link>.</p></InfoCard></div></section>
