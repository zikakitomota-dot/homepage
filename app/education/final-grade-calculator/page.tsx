...
export default function FinalGradeCalculatorPage() {
  return <div className="min-h-screen bg-background"><SiteHeader /><main>
    ...
    <section className="border-y border-border/60 bg-blue-50/40"><div className="mx-auto max-w-[1000px] px-4 py-14 sm:px-6 lg:px-8 lg:py-20"><h2 className="text-3xl font-bold tracking-tight">Interpret feasibility before planning a study target</h2><div className="mt-7 grid gap-5 md:grid-cols-3"><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="font-bold">Required score below 0%</h3><p className="mt-2 text-muted-foreground">The target is mathematically secured under the entered structure, but completing the final may still be required.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="font-bold">Required score from 0–100%</h3><p className="mt-2 text-muted-foreground">The target is arithmetically possible. Compare the result with your own preparation evidence rather than treating it as a prediction.</p></div><div className="rounded-2xl border border-border/70 bg-white p-6"><h3 className="font-bold">Required score above 100%</h3><p className="mt-2 text-muted-foreground">The final alone cannot reach the target on a normal scale. Check for remaining coursework, extra credit or an incorrect input.</p></div></div><p className="mt-6 max-w-3xl leading-relaxed text-muted-foreground"><strong>Important:</strong> confirm that the “current grade” describes only work completed before the final. Some gradebooks already display the final as a zero or include other missing work, which changes the algebra.</p></div></section>
